...
class ProduitCategorieRepository extends ServiceEntityRepository
{
    ...
    public function getProduits()
    {
        ...
        $sql = "SELECT id, nom, stockRestant, reference, isChangePrix, prixAchat, prixHt, tva, prixTTC, qtt, stockMin FROM `ProduitCategorie` WHERE `application_id` = ".$this->application->getId()."  order by nom";
